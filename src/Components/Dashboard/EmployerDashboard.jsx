                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      ...
                      <div className="bg-white p-6 rounded-lg shadow-sm flex flex-col items-center">
                        ...
                        <h4 className="text-xl font-semibold text-gray-900">
                          {artisanDetails.artisan_details.first_name} {artisanDetails.artisan_details.last_name}
                        </h4>
                      ...
                      <div className="bg-white p-6 rounded-lg shadow-sm">
                        <h4 className="text-lg font-semibold text-gray-900 mb-4">Artisan Details</h4>
                        <div className="space-y-3">
                          <div>
                            <p className="text-sm font-medium text-gray-500">Service</p>
                            <p className="text-gray-900">{artisanDetails.artisan_details.service}</p>
                          </div>
                          <div>
                          ...
                          <div>
                            ...
                            <p className="text-gray-900">{artisanDetails.artisan_details.location}</p>
                          </div>
                          <div>
                            <p className="text-sm font-medium text-gray-500">Pay Rate</p>
                            <p className="text-gray-900">${artisanDetails.artisan_details.pay}/hr</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white p-6 rounded-lg shadow-sm">
                        ...
                        <div className="space-y-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-900">{artisanDetails.job_details.description}</p>
                          </div>
                          <div>
                            <p className="text-sm font-medium text-gray-500">Contact Person</p>
                            <p className="text-gray-900">{artisanDetails.job_details.contact_person}</p>
                          </div>
                          <div>
                            <p className="text-sm font-medium text-gray-500">Contact Phone</p>
                            <p className="text-gray-900">{artisanDetails.job_details.contact_person_phone}</p>
                          </div>
                        </div>
                      </div>
                    </div>
