        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="summary-section bg-gray-50 p-6 rounded-lg shadow-md">
            ...
            <div className="flex space-x-4 mt-6">
              <button
                className="w-1/2 py-4 text-sm bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 focus:outline-none transition-all duration-300"
                onClick={handleContinue}
              >
                Continue
              </button>
              <button
                className="w-1/2 py-4 text-sm bg-red-600 text-white font-semibold rounded-lg hover:bg-red-700 focus:outline-none transition-all duration-300"
